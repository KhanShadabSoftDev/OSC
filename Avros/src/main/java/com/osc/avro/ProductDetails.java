...
public class ProductDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7236421359298251178L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductDetails\",\"namespace\":\"com.osc.avro\",\"fields\":[{\"name\":\"productId\",\"type\":\"string\"},{\"name\":\"productName\",\"type\":\"string\"},{\"name\":\"productDescription\",\"type\":\"string\"},{\"name\":\"productImage\",\"type\":\"string\"},{\"name\":\"productPrice\",\"type\":\"double\"},{\"name\":\"categoryId\",\"type\":\"string\"},{\"name\":\"dateAdded\",\"type\":\"string\"}]}");
  ...
  public static ProductDetails fromByteBuffer(
   ...
   private java.lang.CharSequence productImage;
   ...
   * @param productImage The new value for productImage
   * @param productPrice The new value for productPrice
   * @param categoryId The new value for categoryId
   * @param dateAdded The new value for dateAdded
   */
  public ProductDetails(java.lang.CharSequence productId, java.lang.CharSequence productName, java.lang.CharSequence productDescription, java.lang.CharSequence productImage, java.lang.Double productPrice, java.lang.CharSequence categoryId, java.lang.CharSequence dateAdded) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: productImage = (java.lang.CharSequence)value$; break;
    case 4: productPrice = (java.lang.Double)value$; break;
    case 5: categoryId = (java.lang.CharSequence)value$; break;
    case 6: dateAdded = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return The value of the 'productImage' field.
   */
  public java.lang.CharSequence getProductImage() {
    return productImage;
  }
   ...
   * @param value the value to set.
   */
  public void setProductImage(java.lang.CharSequence value) {
   ...
   * @return The value of the 'dateAdded' field.
   */
   ...
   */
  public static com.osc.avro.ProductDetails.Builder newBuilder() {
    return new com.osc.avro.ProductDetails.Builder();
  }
   ...
   * @return A new ProductDetails RecordBuilder
   */
  public static com.osc.avro.ProductDetails.Builder newBuilder(com.osc.avro.ProductDetails.Builder other) {
    if (other == null) {
      return new com.osc.avro.ProductDetails.Builder();
    } else {
      return new com.osc.avro.ProductDetails.Builder(other);
    }
  }
   ...
   * @return A new ProductDetails RecordBuilder
   */
  public static com.osc.avro.ProductDetails.Builder newBuilder(com.osc.avro.ProductDetails other) {
    if (other == null) {
      return new com.osc.avro.ProductDetails.Builder();
    } else {
      return new com.osc.avro.ProductDetails.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.osc.avro.ProductDetails.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.productImage)) {
      ...
      if (isValidValue(fields()[6], other.dateAdded)) {
        this.dateAdded = data().deepCopy(fields()[6].schema(), other.dateAdded);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.osc.avro.ProductDetails other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder setProductName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder clearProductName() {
      productName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder setProductDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder clearProductDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder setProductImage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder clearProductImage() {
      productImage = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder setProductPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder clearProductPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder setCategoryId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder clearCategoryId() {
      categoryId = null;
    ...
    /**
      * Sets the value of the 'dateAdded' field.
      * @param value The value of 'dateAdded'.
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder setDateAdded(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return True if the 'dateAdded' field has been set, false otherwise.
      */
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.ProductDetails.Builder clearDateAdded() {
      dateAdded = null;
    ...
    public ProductDetails build() {
      try {
        ...
        record.productImage = fieldSetFlags()[3] ? this.productImage : (java.lang.CharSequence) defaultValue(fields()[3]);
        record.productPrice = fieldSetFlags()[4] ? this.productPrice : (java.lang.Double) defaultValue(fields()[4]);
        record.categoryId = fieldSetFlags()[5] ? this.categoryId : (java.lang.CharSequence) defaultValue(fields()[5]);
        record.dateAdded = fieldSetFlags()[6] ? this.dateAdded : (java.lang.CharSequence) defaultValue(fields()[6]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.productImage = in.readString(this.productImage instanceof Utf8 ? (Utf8)this.productImage : null);

      this.productPrice = in.readDouble();

      this.categoryId = in.readString(this.categoryId instanceof Utf8 ? (Utf8)this.categoryId : null);

      this.dateAdded = in.readString(this.dateAdded instanceof Utf8 ? (Utf8)this.dateAdded : null);
