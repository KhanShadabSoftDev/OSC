...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8628824534364940538L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.osc.avro\",\"fields\":[{\"name\":\"productId\",\"type\":\"string\"},{\"name\":\"productQuantity\",\"type\":\"int\"}]}");
   ...
   */
  public Product(java.lang.CharSequence productId, java.lang.Integer productQuantity) {
   ...
   */
  public static com.osc.avro.Product.Builder newBuilder() {
    return new com.osc.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.osc.avro.Product.Builder newBuilder(com.osc.avro.Product.Builder other) {
    if (other == null) {
      return new com.osc.avro.Product.Builder();
    } else {
      return new com.osc.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.osc.avro.Product.Builder newBuilder(com.osc.avro.Product other) {
    if (other == null) {
      return new com.osc.avro.Product.Builder();
    } else {
      return new com.osc.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.osc.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.osc.avro.Product other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.Product.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.Product.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.Product.Builder setProductQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.Product.Builder clearProductQuantity() {
