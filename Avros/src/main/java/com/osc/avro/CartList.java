...
public class CartList extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8313177559661086136L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CartList\",\"namespace\":\"com.osc.avro\",\"fields\":[{\"name\":\"products\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Product\",\"fields\":[{\"name\":\"productId\",\"type\":\"string\"},{\"name\":\"productQuantity\",\"type\":\"int\"}]}}}]}");
  ...
  public static CartList fromByteBuffer(
   ...
   private java.util.List<com.osc.avro.Product> products;
   ...
   */
  public CartList(java.util.List<com.osc.avro.Product> products) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: products = (java.util.List<com.osc.avro.Product>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<com.osc.avro.Product> getProducts() {
    return products;
  }
   ...
   */
  public void setProducts(java.util.List<com.osc.avro.Product> value) {
    this.products = value;
  }
   ...
   */
  public static com.osc.avro.CartList.Builder newBuilder() {
    return new com.osc.avro.CartList.Builder();
  }
   ...
   * @return A new CartList RecordBuilder
   */
  public static com.osc.avro.CartList.Builder newBuilder(com.osc.avro.CartList.Builder other) {
    if (other == null) {
      return new com.osc.avro.CartList.Builder();
    } else {
      return new com.osc.avro.CartList.Builder(other);
    }
  }
   ...
   * @return A new CartList RecordBuilder
   */
  public static com.osc.avro.CartList.Builder newBuilder(com.osc.avro.CartList other) {
    if (other == null) {
      return new com.osc.avro.CartList.Builder();
    } else {
      return new com.osc.avro.CartList.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CartList>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.osc.avro.CartList.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.osc.avro.CartList other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.products)) {
        this.products = data().deepCopy(fields()[0].schema(), other.products);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.CartList.Builder setProducts(java.util.List<com.osc.avro.Product> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.osc.avro.CartList.Builder clearProducts() {
      products = null;
    ...
    public CartList build() {
      try {
        ...
        record.products = fieldSetFlags()[0] ? this.products : (java.util.List<com.osc.avro.Product>) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (com.osc.avro.Product e0: this.products) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<com.osc.avro.Product> a0 = this.products;
      if (a0 == null) {
        a0 = new SpecificData.Array<com.osc.avro.Product>((int)size0, SCHEMA$.getField("products").schema());
        this.products = a0;
      } else a0.clear();
      SpecificData.Array<com.osc.avro.Product> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<com.osc.avro.Product>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          com.osc.avro.Product e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new com.osc.avro.Product();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
